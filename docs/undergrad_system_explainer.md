...
本文默认解释当前主分支的系统结构；截至本文更新时，当前世界状态版本为 `59`。

当前前端已经拆成 `首页 / 市场 / 生活与地产 / 财政与政府 / 小镇微博 / 日志与观察 / 智能体教学` 七个子页面。这样做不是为了“看起来更复杂”，而是为了把地图、市场、财政、公开舆论、日志观察和教学解释分成不同工作台，降低理解成本。

地图也已经不再只是背景网格，而是一个分层的像素世界：树林、水面、沙滩、建筑、人物和事件反应会叠在一起显示。这样学生能把“系统事件”直接看成“地图上的具体动作”，而不是只读右侧文字。

此外，系统还加入了 `小镇微博`。它的作用不是“再给角色一个聊天窗口”，而是把个人体验、判断、情绪和八卦公开化，让公开信号反过来影响市场、游客、政府和地图上的群体行为。
